...
<html lang="zh-cn">
  ...
  <body>
    <div class="maincont">
     ...
     <ul class="userNav">
      <li><span class="glyphicon glyphicon-list-alt"></span><a href="{{url('index/order')}}">我的订单</a></li>
      ...
      <li><span class="glyphicon glyphicon-map-marker"></span><a href="{{url('index/user_address')}}">收货地址管理</a></li>
