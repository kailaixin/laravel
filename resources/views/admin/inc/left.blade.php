	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			...
			<!-- <dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="/admin/vip.html" target="main"
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="/admin/img/coin03.png" /><img class="icon2"
						src="/admin/img/coin04.png" /> 友情管理<img class="icon3"
						src="/admin/img/coin19.png" /><img class="icon4"
						src="/admin/img/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="{{route ('friend')}}"
						target="main" class="cks">友情添加</a><img class="icon5"
						src="/admin/img/coin21.png" />
						
				</dd>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="{{route ('friend_list')}}"
						target="main" class="cks">友情列表</a><img class="icon5"
						src="/admin/img/coin21.png" />
			...
			<!-- <dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="/admin/topic.html" target="main"
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="/admin/wish.html" target="main"
